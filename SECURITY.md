...
`forge fmt --check`, `forge build --sizes`, the unit, regression and invariant suites (402 tests;
...
6,073 B, seven link sites; after the redesign `Vault` is 25,765 B, `ValoremLib` 5,993 B,
