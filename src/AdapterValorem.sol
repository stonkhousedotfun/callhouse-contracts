...
abstract contract AdapterValorem {
    ...
    ///
    ///      Under write-on-fill the vault holds no unsold option ERC-1155 at this point; if it ever
    ///      did, they are worthless after expiry and, critically, holding them does NOT block the
    ///      claim redemption. Their collateral comes back through the claim.
