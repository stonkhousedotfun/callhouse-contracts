...
// VENDORED TEST FIXTURE -- T-OP-089. This is Uniswap v3-core's TickMath.sol: delete this comment block (it sits
// between upstream's own SPDX line above and its pragma below) and rename `library TickMathUpstream` back to
// `library TickMath`, and the file is byte-identical to the one fetched from
